      ...
      {!isMobile && (
        <div style={{ flex: 1, position: 'relative', pointerEvents: 'none' }}>
           ...
           <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.2 }}
             style={{ position: 'absolute', top: '5%', right: '5%', padding: '15px 25px', background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(0,255,65,0.2)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', gap: '15px', borderRadius: '4px' }}>
           ...
           <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.3 }}
             style={{ position: 'absolute', top: '35%', right: '15%', padding: '15px 25px', background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(245,166,35,0.3)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', gap: '15px', borderRadius: '4px' }}>
           ...
           <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.4 }}
             style={{ position: 'absolute', top: '55%', right: '2%', padding: '15px 25px', background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(0,245,255,0.3)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', gap: '15px', borderRadius: '4px' }}>
           ...
           <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.5 }}
             style={{ position: 'absolute', top: '75%', right: '10%', padding: '15px 25px', background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(168,85,247,0.3)', backdropFilter: 'blur(8px)', display: 'flex', alignItems: 'center', gap: '15px', borderRadius: '4px' }}>
